...
import com.apekshapms.controller.consultant.DiagnosisCardController1;
...
public class SearchPatientDiagnosisController implements Controller{
    ...
    @FXML
    private Button btnIssueDiagnosisCard;
    ...
    @FXML
    void handleIssueDiagnosisCardButton(ActionEvent event) {
        try {
            //get the selected item in the table row
            Patient patient = tableSearch.getSelectionModel().getSelectedItem();
            ...
            //Create Diagnosis Card object from patient id
            DiagnosisCard diagnosisCard = new DiagnosisCard();
            diagnosisCard.setPatient(patient);
            //pass object to diagnosisCard controller
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        civilTableColumn.setCellValueFactory(new PropertyValueFactory<Patient,String>("civilStatus"));
